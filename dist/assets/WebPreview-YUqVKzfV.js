import{n as S,k,i as $,E as D,r as a,j as r}from"./terminal-runtime-3lr-69jY.js";import{I as m}from"./index-leVzvik2.js";const q="19.2.3",F="0.562.0",V=["src/main.tsx","src/index.tsx","index.tsx"],Y=()=>{const{files:c}=S(),{addConsoleLog:h,previewFileId:p,language:L}=k(),{mode:l}=$(),{detectedUrls:g,activeUrl:o,setActiveUrl:y,registerDetectedUrls:C}=D(),[b,w]=a.useState(""),[v,E]=a.useState("Initializing..."),[j,_]=a.useState(""),O=a.useRef(null),d=(e,t)=>L==="pt"?e:t;a.useEffect(()=>{l==="local-runtime"&&o&&_(o)},[l,o]),a.useEffect(()=>{if(l==="local-runtime")return;const e=t=>{t.data&&(t.data.type==="CONSOLE_LOG"?h(`[Preview] ${t.data.message}`):t.data.type==="PREVIEW_ERROR"&&h(`[Preview Error] ${t.data.message}`))};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)},[h,l]);const u=e=>{const t=S.getState().files;let n=e.name,i=t[e.parentId||""];for(;i&&i.id!=="root";)n=`${i.name}/${n}`,i=t[i.parentId||""];return n},f=a.useMemo(()=>Object.values(c).filter(e=>e.type==="file"),[c]),M=e=>{const t=e.replace(/^\/+/,"");return f.find(n=>u(n)===t)},I=()=>{for(const e of V){const t=M(e);if(t)return t}return f.find(e=>e.name.endsWith(".tsx")&&/(createRoot\s*\(|ReactDOM\.createRoot\s*\()/.test(e.content||""))},U=e=>{E("Preview Error"),w(`<!doctype html><html><body style="margin:0;padding:24px;background:#1e1e1e;color:#d4d4d4;font-family:ui-sans-serif,system-ui;"><h2 style="margin:0 0 8px;">Web Preview</h2><p style="margin:0;">${e}</p></body></html>`)},A=e=>`
<script>
